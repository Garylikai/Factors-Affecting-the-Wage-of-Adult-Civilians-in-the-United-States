...
The raw extract contains 163,543 observations. After filtering and model-specific exclusions, the reported selection model uses 46,247 observations: 43,766 observed wage outcomes and 2,481 censored outcomes. The inverse Mills ratio is statistically significant in the reported model, providing evidence that a simple wage regression on the observed working sample would be affected by selection.
